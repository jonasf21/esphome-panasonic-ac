...
static const int INIT_TIMEOUT = 30000;       // Time to wait before initializing after boot
...
static const int POLL_INTERVAL = 2000;      // The interval at which to poll the AC
static const int RESPONSE_TIMEOUT = 200;     // The timeout after which we expect a response to our last command
